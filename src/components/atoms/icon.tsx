...
export const ViewIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth="1.5"
    />
    <circle cx="12" cy="12" r="3" stroke="#16151C" strokeWidth="1.5" />
  </svg>
);
...
export const MoreIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#A2A1A8" fill="none"  {...props}>
